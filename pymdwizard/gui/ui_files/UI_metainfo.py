...
class Ui_fgdc_metainfo(object):
    def setupUi(self, fgdc_metainfo):
        ...
        self.button_today = QtWidgets.QPushButton(self.help_metd)
        self.button_today.setMaximumSize(QtCore.QSize(120, 60))
        self.button_today.setObjectName("button_today")
        self.verticalLayout_9.addWidget(self.button_today)
